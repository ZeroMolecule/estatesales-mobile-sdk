...
mixin _$AuctionsQuery {
  ...
  Map<AuctionKey, SortOrder>? get sort => throw _privateConstructorUsedError;
...
class _$AuctionsQueryImpl extends _AuctionsQuery {
  const _$AuctionsQueryImpl(
      ...
      final Map<AuctionKey, SortOrder>? sort,
  ...
  final Map<AuctionKey, SortOrder>? _sort;
  @override
  Map<AuctionKey, SortOrder>? get sort {
    final value = _sort;
