...
class CompanyAdapter extends TypeAdapter<Company> {
  ...
  Company read(BinaryReader reader) {
    ...
    return Company(
      ...
      photo: fields[10] as RemoteAsset?,
      cover: fields[11] as RemoteAsset?,
    );
  }
...
_$CompanyImpl _$$CompanyImplFromJson(Map<String, dynamic> json) =>
    _$CompanyImpl(
      ...
      photo: remoteAsset.fromJson(json['photo']),
      cover: remoteAsset.fromJson(json['cover']),
    );
...
Map<String, dynamic> _$$CompanyImplToJson(_$CompanyImpl instance) =>
    <String, dynamic>{
      ...
      'photo': remoteAsset.toJson(instance.photo),
      'cover': remoteAsset.toJson(instance.cover),
    };
