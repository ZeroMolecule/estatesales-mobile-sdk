...
abstract class $SortCopyWith<$Res> {
  ...
  @useResult
  $Res call({String key, SortOrder order});
}
...
class _$SortImpl extends _Sort {
  const _$SortImpl({required this.key, required this.order}) : super._();
  ...
  @override
  String toString() {
    return 'Sort(key: $key, order: $order)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, key, order);
...
abstract class _Sort extends Sort {
  const factory _Sort(
      {required final String key, required final SortOrder order}) = _$SortImpl;
