...
class _$RemoteAssetEnhancedImpl extends RemoteAssetEnhanced {
  ...
  @override
  String toString() {
    return 'RemoteAsset.enhanced(id: $id, order: $order, visibility: $visibility, uri: $uri, thumbnailOrNull: $thumbnailOrNull, smallOrNull: $smallOrNull, mediumOrNull: $mediumOrNull, largeOrNull: $largeOrNull)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, id, order, visibility, uri,
  ...
  TResult when<TResult extends Object?>(
    ...
    return enhanced(id, order, visibility, uri, thumbnailOrNull, smallOrNull,
        mediumOrNull, largeOrNull);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return enhanced?.call(id, order, visibility, uri, thumbnailOrNull,
        smallOrNull, mediumOrNull, largeOrNull);
  }
