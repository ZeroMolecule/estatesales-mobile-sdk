...
class _$CompanyImpl extends _Company {
  ...
  @override
  String toString() {
    return 'Company(id: $id, createdAt: $createdAt, updatedAt: $updatedAt, name: $name, about: $about, terms: $terms, privacyPolicy: $privacyPolicy, hideClosedLots: $hideClosedLots, enabled: $enabled, rating: $rating)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, createdAt, updatedAt, name,
      about, terms, privacyPolicy, hideClosedLots, enabled, rating);
...
abstract class _Company extends Company {
  const factory _Company(
      ...
      @HiveField(9) final Rating rating}) = _$CompanyImpl;
